...
with st.sidebar:
    ...
    f_priority = f_evidence = f_cards = None
...
if data_mode == "📂 Dữ liệu mẫu (mặc định)":
    ...
    # Đọc từ sidebar input nếu có, fallback về tên chung
...
with tab2:
    ...
    # Color sentiment
    def color_sent(val):
        c = {"Positive": "#dcfce7", "Negative": "#fee2e2", "Neutral": "#fef9c3"}.get(val, "white")
